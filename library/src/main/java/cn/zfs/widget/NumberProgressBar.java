...
/**
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = attributes.getColor(R.styleable.NumberProgressBar_npbTextColor, DEFAULT_TEXT_COLOR);
        mTextSize = attributes.getDimension(R.styleable.NumberProgressBar_npbTextSize, default_text_size);

        mReachedBarHeight = attributes.getDimension(R.styleable.NumberProgressBar_npbReachedBarHeight, default_reached_bar_height);
        mUnreachedBarHeight = attributes.getDimension(R.styleable.NumberProgressBar_npbUnreachedBarHeight, default_unreached_bar_height);
        mOffset = attributes.getDimension(R.styleable.NumberProgressBar_npbTextOffset, default_progress_text_offset);

        int textVisible = attributes.getInt(R.styleable.NumberProgressBar_npbTextVisibility, PROGRESS_TEXT_VISIBLE);
        if (textVisible != PROGRESS_TEXT_VISIBLE) {
            mIfDrawText = false;
        }

        setProgress(attributes.getInt(R.styleable.NumberProgressBar_npbProgress, 0));
        setMax(attributes.getInt(R.styleable.NumberProgressBar_npbMax, 100));
