...
public class NumberProgressBar extends View {
    ...
    private static final String INSTANCE_TEXT_VISIBLE = "text_visibility";
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putBoolean(INSTANCE_TEXT_VISIBLE, isProgressTextVisible());
        return bundle;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            setProgressTextVisible(bundle.getBoolean(INSTANCE_TEXT_VISIBLE, true));
