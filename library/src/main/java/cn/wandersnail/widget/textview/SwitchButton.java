...
public class SwitchButton extends CompoundButton {
    ...
    public static final int ENABLE_ATTR = android.R.attr.state_enabled;
    public static final int CHECKED_ATTR = android.R.attr.state_checked;
    public static final int PRESSED_ATTR = android.R.attr.state_pressed;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mTintColor == 0) {
            ...
            int resId = getContext().getResources().getIdentifier("colorAccent", "attr", getContext().getPackageName());
            if (resId != 0) {
    ...
    public static ColorStateList getDefaultBackColor() {
        int[] colors = {-0x66bb24a2, -0x333334, -0x333334, -0xbb24a2, -0xbb24a2, -0x333334};
        return new ColorStateList(getStates(), colors);
    }
    
    public static ColorStateList getDefaultThumbColor() {
        int[] colors = {-0x1, -0x1, -0x1, -0x1, -0x1, -0x1};
        return new ColorStateList(getStates(), colors);
    }
    
    public static ColorStateList generateBackColor(int color) {
        int[] colors = {color & -0x66000001, -0x333334, -0x333334, color & -0x22000001, color & -0x22000001, -0x333334};
        return new ColorStateList(getStates(), colors);
    }
    ...
    public static ColorStateList generateBackColorWithTintColor(int tintColor) {
        int[] colors = {tintColor & 0x20ffffff, 0x10000000, tintColor & 0x60ffffff, 0x20000000, tintColor & 0x60ffffff, 0x20000000};
        return new ColorStateList(getStates(), colors);
    }
    ...
    public static ColorStateList generateThumbColorWithTintColor(int tintColor) {
        int[] colors = {tintColor - -0x56000000, -0x454546, tintColor - -0x67000000, tintColor - -0x67000000, tintColor | -0x1000000, -0x111112};
        return new ColorStateList(getStates(), colors);
    }
