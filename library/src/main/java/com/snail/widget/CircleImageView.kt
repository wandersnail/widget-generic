...
class CircleImageView : android.support.v7.widget.AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_civBorderOverlay, DEFAULT_BORDER_OVERLAY)
        mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_civCircleBackgroundColor, DEFAULT_CIRCLE_BACKGROUND_COLOR)
        a.recycle()
        init()
    }
