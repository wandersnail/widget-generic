 ...
 * author: zengfansheng
 */
abstract class BaseItemTouchAdapter<T, VH : BaseItemTouchViewHolder> @JvmOverloads constructor(list: MutableList<T> = ArrayList()) : 
        RecyclerView.Adapter<VH>(), ItemTouchAdapter {
