...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mTintColor == 0) {
            ...
            boolean found = false;
            try {
                int resId = Class.forName(getContext().getPackageName() + ".R$attr").getField("colorAccent").getInt(null);
                if (resId > 0) {
                    found = getContext().getTheme().resolveAttribute(resId, typedValue, true);
                }
    ...
    public static ColorStateList getDefaultThumbColor() {
        int[][] states = new int[][]{
                {-SwitchButton.ENABLE_ATTR, SwitchButton.CHECKED_ATTR},
                {-SwitchButton.ENABLE_ATTR},
                {SwitchButton.PRESSED_ATTR, -SwitchButton.CHECKED_ATTR},
                {SwitchButton.PRESSED_ATTR, SwitchButton.CHECKED_ATTR},
                {SwitchButton.CHECKED_ATTR},
                {-SwitchButton.CHECKED_ATTR}
        };
        int[] colors = new int[] {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};
    ...
    public static ColorStateList getDefaultBackColor() {
        ...
        int[] colors = new int[] {0x9944DB5E, 0xFFCCCCCC, 0xFFCCCCCC, 0xFF44DB5E, 0xFF44DB5E, 0xFFCCCCCC};
        return new ColorStateList(states, colors);
    }
